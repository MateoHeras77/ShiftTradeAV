...
UID:{event_uid}
DTSTAMP:{dtstamp}
DTSTART:{fmt(shift_start_utc)}
DTEND:{fmt(shift_end_utc)}
SUMMARY:{summary}
...
def send_email_with_calendar(recipient_email: str, subject: str, body: str, shift_data, is_for_requester=True) -> bool:
    try:
        msg = MIMEMultipart()
        msg['Subject'] = subject
        msg['From'] = SENDER_EMAIL
        ...
        if calendar_content:
            ...
            attachment.add_header('Content-Type', 'text/calendar; method=PUBLISH')
