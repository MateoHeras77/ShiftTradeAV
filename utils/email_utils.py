"""
Email utilities for sending notifications and calendar attachments.
Handles all email-related functionality for the ShiftTradeAV application.
"""
...
def send_email_with_calendar(recipient_email, subject, body, shift_data, is_for_requester=True):
    ...
    """
    try:
        # Import calendar utils here to avoid circular imports
        from .calendar_utils import create_calendar_file
