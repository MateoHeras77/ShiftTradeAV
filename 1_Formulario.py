...
with st.form("shift_request_form"):
    ...
    requester_employee_number = st.text_input("Número de empleado del solicitante (UKG)")
    ...
    cover_employee_number = st.text_input("Número de empleado del compañero (UKG)")
